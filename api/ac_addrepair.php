...
if (!isset($_SESSION['intLine'])) {
	...
	if ((string)$key != "") {
		...
		$_SESSION["repair_model"][$intNewLine] = $_REQUEST["repair_model"];
		$_SESSION["repair_number"][$intNewLine] = $_REQUEST["repair_number"];
		$_SESSION["repair_detail"][$intNewLine] = $_REQUEST["repair_detail"];
